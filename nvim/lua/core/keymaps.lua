...
-- Move Lines
map("n", "<C-A-down>", "<cmd>m .+1<cr>==", opts)
map("n", "<C-A-up>", "<cmd>m .-2<cr>==", opts)
map("i", "<C-A-down>", "<esc><cmd>m .+1<cr>==gi", opts)
map("i", "<C-A-up>", "<esc><cmd>m .-2<cr>==gi", opts)
map("v", "<C-A-down>", ":m '>+1<cr>gv=gv", opts)
map("v", "<C-A-up>", ":m '<-2<cr>gv=gv", opts)
